...
export const GeminiPromptBox = () => {
  ...
  return (
    <div className="w-full max-w-3xl mx-auto my-6 text-left" id="gemini-prompt-generator-box">
      <div className="rounded-full bg-white dark:bg-neutral-900 border border-neutral-200/90 dark:border-neutral-800 p-2 shadow-sm hover:shadow-md transition-all">
        ...
        <form onSubmit={handleGenerate}>
          <div className="relative flex items-center">
            <input
              ...
              className="w-full pl-6 pr-28 sm:pr-36 py-3.5 sm:py-4 rounded-full bg-neutral-100 dark:bg-neutral-800/90 border-0 text-xs sm:text-sm font-medium text-neutral-900 dark:text-white placeholder:text-neutral-500 dark:placeholder:text-neutral-400 focus:outline-none focus:ring-2 focus:ring-[#E60023]/40 transition-all shadow-inner"
              id="gemini-idea-input"
            />
            <button
              type="submit"
              className="absolute right-1.5 top-1.5 bottom-1.5 px-4 sm:px-6 rounded-full bg-[#E60023] hover:bg-[#ad081b] active:scale-95 text-white text-xs sm:text-sm font-bold flex items-center gap-1.5 shadow-sm transition-all cursor-pointer"
