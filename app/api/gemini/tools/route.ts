...
Analyze the provided image and generate a highly detailed, descriptive prompt that could be used in an AI image generator to recreate the image.
Include details about the subject, lighting, composition, colors, style, and camera angle.
...
Return ONLY a valid JSON object with the following schema:
{
  ...
  "negative_prompt": "Any negative prompt elements if needed",
  "aspect_ratio": "16:9 or 1:1 or 9:16 etc",
  "confidence": "high",
  "analysis": {
    "subject": "...",
    "lighting": "...",
...
async function generateWithModel(ai: GoogleGenAI, preferredModel: string | undefined, payload: any) {
  const candidateModels = [
    preferredModel && !preferredModel.includes('imagen') ? preferredModel : 'gemini-2.5-flash',
    'gemini-2.5-flash',
    'gemini-2.0-flash',
    'gemini-1.5-flash',
  ];
